defmodule PhoenixPlaygroundWeb.Router do
  ...
  pipeline :browser do
    ...
    plug :put_root_layout, html: {PhoenixPlaygroundWeb.Layouts, :root}
  ...
  # scope "/api", PhoenixPlaygroundWeb do
  #   pipe_through :api
  # end

  # Enable LiveDashboard and Swoosh mailbox preview in development
  if Application.compile_env(:phoenix_playground, :dev_routes) do
