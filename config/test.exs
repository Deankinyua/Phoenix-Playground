...
config :phoenix_playground, PhoenixPlaygroundWeb.Endpoint,
  ...
  secret_key_base: "AEoI7QcRQyoUep2inwoPwiF/RlUqh/frcXORyRlNZMtK72RB3lUeG+ppdlBpjEnW",
  server: false

# In test we don't send emails.
config :phoenix_playground, PhoenixPlayground.Mailer, adapter: Swoosh.Adapters.Test
